...
const Usuarios = () => {
    //Datos
    const [registros, setRegitros] = useState<Usuario[]>([]);
    ...
    return (
        ...
        <div className="contaier mt-4">
            <div className="card">
                <div className="card-header d-flex justify-content-between align-items-center">Usuarios existentes
                ...
                <div className="card-body">
                    <table className="table table-striped">
                        ...
                        </thead>
                        {
                            ...
                            <tbody>
                                <tr>
                                    <td colSpan={5}>No hay regustros para mostrar</td>
                                </tr>
                            </tbody>
                        } 
                        {
